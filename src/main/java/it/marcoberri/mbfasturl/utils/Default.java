...
/**
 * This class supplies a lot of methods to handle default values and types
 * conversion.
 * 
...
public class Default {
     ...
     * @return true if both left and right are null or left.equals(right), false
     *         otherwise
     */
    ...
    /**
     * Default for null or empty Strings. A String is empty if it's null or if
     ...
     *            the default
     * @param prefix
     *            to prepend if string is not empty (can be null)
     * @param suffix
     *            to append if string is not empty (can be null)
     * @return the target itself if it's not empty, def otherwise
     * @see StringUtil#isEmpty(String)
     */
     ...
     *            the default
     * @param prefix
     *            to prepend if string is not null (can be null)
     * @param suffix
     *            to append if string is not null (can be null)
     * @return the target itself if it's not null, def otherwise
     */
    ...
    /**
     * Returns a boolean from the String representation of the target. If the
     * String is empty false is returned.
     * 
     * @param target
     *            the target to handle
     * @return true if target is "true", "on", "ok", "yes", "1" (case
    ...
    /**
     * Returns a boolean from the Boolean, Number or String representation of
     * the target. If the target is null or empty the default is returned.
     * 
     * @param target
     *            the target to handle
     * @param def
     *            the default
     * @return def if target is null or empty, true if target is true, not zero,
     *         "true", "on", "enable", "yes", "ok", "1" (case insensitive),
     *         false otherwise
     */
	...
	return "true".equalsIgnoreCase(s) || "on".equalsIgnoreCase(s) || "enable".equalsIgnoreCase(s) || "yes".equalsIgnoreCase(s) || "ok".equalsIgnoreCase(s) || "1".equalsIgnoreCase(s) || "yeah!".equalsIgnoreCase(s) || // OK,
																											    // I'm
																											    // a
																											    // bit
																											    // stupid,
