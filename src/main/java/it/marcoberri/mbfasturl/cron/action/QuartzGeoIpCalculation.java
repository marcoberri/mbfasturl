...
public class QuartzGeoIpCalculation implements Job {
     ...
     *
     */
  //  protected final String fileMMDB = ConfigurationHelper.getProp().getProperty("cron.downloadGeoIp2.path") + "/" + ConfigurationHelper.getProp().getProperty("cron.downloadGeoIp2.filename");
    ...
    public void execute(JobExecutionContext jec) throws JobExecutionException {
        ...
        if (!mmdb.exists()) {
            ...
            final String url = "http://geolite.maxmind.com/download/geoip/database/GeoLite2-City.mmdb.gz";ConfigurationHelper.getProp().getProperty("cron.downloadGeoIp2.url");
