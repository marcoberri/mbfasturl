...
public final class DateTimeUtil {
	 ...
	 *            lingua di default
	 * @param format
	 *            formato della data vedi esempi tsDefaultFormats
	...
	/**
	 * Return a String value of Now() with an offset es: -1d per il giorno prima
	 * es: +3h per tre ore dopo es: 5m tra 5 minuti es: 5M tra 5 mesi (mese
	 * standard = 30 giorni)
	 *
	 * @param offset
	 * @return a java.sql.Timestamp representing current timestamp with an
	 *         offset
	 */
