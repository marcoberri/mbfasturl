...
public class StringUtil {
	...
	/**
	 * /** Returns a capitalized String. Make the first character upper case
	 * leaving untouched the other ones Eg: this is my String -> This is my
	 * String
	 *
	 * @param s
	...
	/**
	 * Returns a String where all words are capitalized, except invariant words
	 * (case insensitive) Eg: this is my string (invariant: this is my) -> This
	 * is my String (first word will be always capitalized)
	 *
	 * @param s
	 *            String to capitalize
	 * @param invariant
	 *            String array of word that should not be capitalized
	 * @param tokens
	 *            used to tokenize
	 * @param special
	 *            special tokens, like '
	 * @param first
	 *            capitalize always first word (default true)
	 * @return a capitalized String
	 */
	 ...
	 * 
	 * @param f
	 *            nome del file in formato string
	...
	/**
	 * Create a list from a file where an element of the list is a line of the
	 * text file
	 *
	 * @param filePath
	 *            Relative path
	...
	/**
	 * prende la stringa "la sfiga e' con noi" e diventa
	 * "sfiga diventa con noi (La)"
	 * 
	 * @param title
	 * @return
	 */
	...
	/*
	 * Se (len == 0) ritorna un vettore di lunghezza appropriata Se (len > 0)
	 * ritorna un vettore esattamente uguale a len scartando i risultati in
	 * eccesso o con padding fatto di stringhe vuote (non null) Se (len < 0)
	 * ritorna un vettore di lunghezza al piu' uguale a (-len) mettendo tutti i
	 * risultati eccedenti nell'ultima stringa (separati da tok.charAt(0) o ' ')
	 * e senza padding
	 */
	/**
	 *
